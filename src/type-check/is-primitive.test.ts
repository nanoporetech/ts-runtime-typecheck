...
import { isArray, isBoolean, isDefined, isDictionary, isFunction, isIndex, isIndexable, isNullish, isNumber, isOptArray, isOptBoolean, isOptDictionary, isOptFunction, isOptIndex, isOptIndexable, isOptNumber, isOptRecord, isOptString, isRecord, isString, isUndefined } from './is-primitive';
...
describe('is primitive', () => {
  ...
  it('depreciated functions are aliases', () => {
    expect(isRecord).toBe(isDictionary);
    expect(isOptRecord).toBe(isOptDictionary);
  });
});